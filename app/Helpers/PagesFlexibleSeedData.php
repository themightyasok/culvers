...
final class PagesFlexibleSeedData
{
    ...
    public static function centreMapRow(): array
    {
        ...
        $categorySpecs = [
            ...
            [$eatDrinkGroup, 'grab-go', __('Grab & Go', 'culvers'), '/eat-drink/?type=grab-go'],
            [$eatDrinkGroup, 'restaurants', __('Restaurants', 'culvers'), '/eat-drink/?type=restaurants'],
            [$eatDrinkGroup, 'healthy-options', __('Healthy Options', 'culvers'), '/eat-drink/?type=healthy-options'],
            [$eatDrinkGroup, 'cafes', __('Cafés', 'culvers'), '/eat-drink/?type=cafes'],
