...
<button
  ...
  <span
    class="centre-map__category-bullet mt-0.5 inline-flex size-3 shrink-0 items-center justify-center rounded-full border border-lighter-cream/60 transition max-lg:mt-0 lg:mt-0"
