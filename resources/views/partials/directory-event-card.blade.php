@php
  /**
   * Event directory card — back-compat shim.
   *
   ...
   * {@see App\Directory\Cards\DirectoryCardSpecFactory::forEvent()}.
   */
  $directory_card_spec = \App\Directory\Cards\DirectoryCardSpecFactory::forEvent(
