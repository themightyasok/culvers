...
@if($href !== '' && $title !== '')
  <a
    ...
    <span
      ...
      <span
        aria-hidden="true"
        class="btn btn-outline px-7 text-glowleaf opacity-0 transition-opacity duration-300 ease-out motion-safe:group-hover/card:opacity-100 motion-safe:group-focus-within/card:opacity-100 motion-reduce:hidden max-sm:hidden">
        {{ __('Explore', 'culvers') }}
      </span>
    </span>
  </a>
